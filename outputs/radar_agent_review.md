...
- generated_at: `2026-06-17T17:15:55.159087+00:00`
- overall_decision: `防守`
...
- evidence: top_sector=High Beta / EV(2); top_type=event_driven_volatility(5)

### 预期差代理

- status: `warn`
- conclusion: 验证催化、成交和价格是否真的形成超预期，而不是只靠热度。
- evidence: avg_top5_gap=62.16; min_top5_gap=50.0; confirmed_signal_count=0
...
- evidence: avg_payoff=51.54; avg_execution=58.43; avg_risk=7.36

### 当前价确认代理

- status: `fail`
- conclusion: 检查 Finnhub quote 是否支持 Top 候选仍沿主路径运行。
- evidence: confirming=4; failed=1; missing=0
...
| 2 | BABA | 共振不足 | 共振 58; 预期差 86.79; 赔率 53.04; 风险 12.0; 闸门 不具备高置信优势; 信号 blocked | 风险标记：current_quote_failed_risk / 历史相似样本不足 / 逼空/期权相关数据为 proxy / 精准闸门未通过 / 当前价确认失败 / 信号闸门：技术结构未确认 / 板块主线不够强 / 当前价确认失败 |
| 3 | NVDA | 共振不足 | 共振 58.0; 预期差 58; 赔率 51.93; 风险 8.0; 闸门 不具备高置信优势; 信号 blocked | 风险标记：weak_close_distribution_risk / 历史相似样本不足 / 逼空/期权相关数据为 proxy / 精准闸门未通过 / 信号闸门：技术结构未确认 / 成交量没有形成确认 / 赔率质量不足 |
| 4 | COIN | 共振不足 | 共振 58.0; 预期差 58; 赔率 50.14; 风险 0; 闸门 不具备高置信优势; 信号 blocked | 历史相似样本不足 / 逼空/期权相关数据为 proxy / 精准闸门未通过 / 信号闸门：技术结构未确认 / 成交量没有形成确认 / 赔率质量不足 |
| 5 | RIVN | 共振不足 | 共振 58; 预期差 58; 赔率 42.8; 风险 16.8; 闸门 不具备高置信优势; 信号 blocked | 风险标记：weak_close_distribution_risk / 历史相似样本不足 / 逼空/期权相关数据为 proxy / 精准闸门未通过 / 信号闸门：技术结构未确认 / 成交量没有形成确认 / 赔率质量不足 |
| 6 | TSLA | 共振不足 | 共振 58; 预期差 58; 赔率 41.65; 风险 0; 闸门 不具备高置信优势; 信号 blocked | 历史相似样本不足 / 逼空/期权相关数据为 proxy / 精准闸门未通过 / 信号闸门：催化不足或没有确认新闻 / 技术结构未确认 / 成交量没有形成确认 / 赔率质量不足 |
| 7 | CRSP | 共振不足 | 共振 58; 预期差 50; 赔率 41.09; 风险 0; 闸门 不具备高置信优势; 信号 blocked | 历史相似样本不足 / 逼空/期权相关数据为 proxy / 精准闸门未通过 / 信号闸门：催化不足或没有确认新闻 / 技术结构未确认 / 成交量没有形成确认 / 赔率质量不足 / 预期差不足 |
| 8 | CEG | 共振不足 | 共振 58.0; 预期差 58; 赔率 39.08; 风险 35.2; 闸门 不具备高置信优势; 信号 blocked | 风险标记：news_reversal_or_event_risk / 历史相似样本不足 / 逼空/期权相关数据为 proxy / 精准闸门未通过 / 信号闸门：技术结构未确认 / 成交量没有形成确认 / 赔率质量不足 |
| 9 | AMC | 共振不足 | 共振 58; 预期差 54; 赔率 39.0; 风险 8.98; 闸门 不具备高置信优势; 信号 blocked | 历史相似样本不足 / 逼空/期权相关数据为 proxy / 精准闸门未通过 / 信号闸门：催化不足或没有确认新闻 / 成交量没有形成确认 / 板块主线不够强 / 赔率质量不足 / 预期差不足 / 逼空逻辑只有 proxy，不能作为强共振 |
| 10 | BEAM | 共振不足 | 共振 58; 预期差 50; 赔率 38.97; 风险 0; 闸门 不具备高置信优势; 信号 blocked | 历史相似样本不足 / 逼空/期权相关数据为 proxy / 精准闸门未通过 / 信号闸门：催化不足或没有确认新闻 / 技术结构未确认 / 成交量没有形成确认 / 赔率质量不足 / 预期差不足 |
