...
- generated_at: `2026-09-19T01:28:15.409997+00:00`
- overall_decision: `观察`
...
- evidence: avg_payoff=71.0; avg_execution=80.2; avg_risk=3.67
...
- evidence: validation=early_evidence; completed=1694; leaderboard=validated
...
| ---: | --- | --- | --- | --- |
| 1 | MRK | 可观察候选 | 共振 73.28; 预期差 76.67; 赔率 72.49; 风险 0; 闸门 不具备高置信优势; 信号 confirmed | 历史相似样本不足 / 逼空/期权相关数据为 proxy / 精准闸门未通过 |
| 2 | LLY | 可观察候选 | 共振 82; 预期差 100.0; 赔率 71.38; 风险 0; 闸门 不具备高置信优势; 信号 confirmed | 历史相似样本不足 / 逼空/期权相关数据为 proxy / 精准闸门未通过 |
| 3 | UNH | 可观察候选 | 共振 72.48; 预期差 54; 赔率 69.13; 风险 11.0; 闸门 不具备高置信优势; 信号 confirmed | 历史相似样本不足 / 逼空/期权相关数据为 proxy / 精准闸门未通过 |
