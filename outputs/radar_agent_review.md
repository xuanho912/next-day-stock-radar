...
- generated_at: `2026-09-25T00:48:23.443355+00:00`
- overall_decision: `防守`
...
- evidence: top_sector=Healthcare Quality(2); top_type=pullback_reversal_setup(3)

### 预期差代理

- status: `fail`
- conclusion: 验证催化、成交和价格是否真的形成超预期，而不是只靠热度。
- evidence: avg_top5_gap=52.62; min_top5_gap=41.85; confirmed_signal_count=0
...
- evidence: avg_payoff=63.08; avg_execution=58.07; avg_risk=10.83
...
- evidence: validation=early_evidence; completed=1793; leaderboard=validated
...
| ---: | --- | --- | --- | --- |
| 1 | UNH | 可观察候选 | 共振 74.83; 预期差 58; 赔率 67.38; 风险 0; 闸门 不具备高置信优势; 信号 partial | 历史相似样本不足 / 逼空/期权相关数据为 proxy / 精准闸门未通过 |
| 2 | LLY | 可观察候选 | 共振 63; 预期差 58; 赔率 62.84; 风险 8.0; 闸门 不具备高置信优势; 信号 blocked | 风险标记：weak_close_distribution_risk / 历史相似样本不足 / 逼空/期权相关数据为 proxy / 精准闸门未通过 / 信号闸门：技术结构未确认 / 成交量没有形成确认 / 板块主线不够强 |
| 3 | GOOGL | 可观察候选 | 共振 63; 预期差 41.85; 赔率 59.03; 风险 24.5; 闸门 不具备高置信优势; 信号 blocked | 风险标记：weak_close_distribution_risk / 历史相似样本不足 / 逼空/期权相关数据为 proxy / 精准闸门未通过 / 信号闸门：催化不足或没有确认新闻 / 技术结构未确认 / 成交量没有形成确认 / 预期差不足 |
