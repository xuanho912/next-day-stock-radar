...
- generated_at: `2026-09-25T23:21:56.395758+00:00`
- overall_decision: `观察`
...
- evidence: avg_top5_gap=75.65; min_top5_gap=58.0; confirmed_signal_count=1

### 执行质量代理

- status: `pass`
- conclusion: 检查触发价、失效价、赔率质量和流动性是否可执行。
- evidence: avg_payoff=71.05; avg_execution=73.82; avg_risk=0
...
| ---: | --- | --- | --- | --- |
| 1 | JPM | 可观察候选 | 共振 78.31; 预期差 68.96; 赔率 68.55; 风险 0; 闸门 不具备高置信优势; 信号 partial | 历史相似样本不足 / 逼空/期权相关数据为 proxy / 精准闸门未通过 |
| 2 | V | 可观察候选 | 共振 76.66; 预期差 58; 赔率 69.71; 风险 0; 闸门 不具备高置信优势; 信号 partial | 历史相似样本不足 / 逼空/期权相关数据为 proxy / 精准闸门未通过 |
