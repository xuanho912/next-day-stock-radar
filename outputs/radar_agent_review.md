...
- generated_at: `2026-08-04T15:25:43.191231+00:00`
- overall_decision: `观察`
...
- evidence: avg_payoff=51.96; avg_execution=63.95; avg_risk=4.4
...
- evidence: validation=early_evidence; completed=845; leaderboard=validated
...
| ---: | --- | --- | --- | --- |
| 1 | ARM | 可观察候选 | 共振 77.21; 预期差 58; 赔率 58.84; 风险 0; 闸门 不具备高置信优势; 信号 confirmed | 历史相似样本不足 / 逼空/期权相关数据为 proxy / 精准闸门未通过 |
| 2 | KLAC | 可观察候选 | 共振 68; 预期差 54; 赔率 47.67; 风险 13.2; 闸门 不具备高置信优势; 信号 confirmed | 历史相似样本不足 / 逼空/期权相关数据为 proxy / 精准闸门未通过 |
| 3 | MU | 可观察候选 | 共振 68; 预期差 58; 赔率 49.37; 风险 0; 闸门 不具备高置信优势; 信号 confirmed | 历史相似样本不足 / 逼空/期权相关数据为 proxy / 精准闸门未通过 |
