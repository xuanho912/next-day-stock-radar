...
- generated_at: `2026-08-17T15:49:10.419682+00:00`
- overall_decision: `防守`
...
- evidence: top_sector=Crypto Proxy(1); top_type=pullback_reversal_setup(3)

### 预期差代理

- status: `fail`
- conclusion: 验证催化、成交和价格是否真的形成超预期，而不是只靠热度。
- evidence: avg_top5_gap=52.76; min_top5_gap=44.85; confirmed_signal_count=1
...
- evidence: avg_payoff=55.23; avg_execution=61.7; avg_risk=7.98
...
| ---: | --- | --- | --- | --- |
| 1 | MSTR | 可观察候选 | 共振 63; 预期差 55.44; 赔率 53.88; 风险 0; 闸门 不具备高置信优势; 信号 blocked | 历史相似样本不足 / 逼空/期权相关数据为 proxy / 精准闸门未通过 / 信号闸门：催化不足或没有确认新闻 / 技术结构未确认 / 成交量没有形成确认 / 板块主线不够强 / 预期差不足 |
| 2 | V | 可观察候选 | 共振 68; 预期差 58; 赔率 56.13; 风险 0; 闸门 不具备高置信优势; 信号 confirmed | 历史相似样本不足 / 逼空/期权相关数据为 proxy / 精准闸门未通过 |
| 3 | PDD | 可观察候选 | 共振 63; 预期差 44.85; 赔率 55.68; 风险 23.94; 闸门 不具备高置信优势; 信号 blocked | 风险标记：news_reversal_or_event_risk / 历史相似样本不足 / 逼空/期权相关数据为 proxy / 精准闸门未通过 / 信号闸门：催化不足或没有确认新闻 / 技术结构未确认 / 成交量没有形成确认 / 板块主线不够强 / 预期差不足 |
