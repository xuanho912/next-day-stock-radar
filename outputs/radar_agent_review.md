...
- generated_at: `2026-09-22T17:33:57.964513+00:00`
- overall_decision: `观察`
...
- evidence: avg_top5_gap=64.4; min_top5_gap=58.0; confirmed_signal_count=1
...
- evidence: avg_payoff=64.06; avg_execution=75.34; avg_risk=0
...
- evidence: validation=early_evidence; completed=1721; leaderboard=validated
...
| ---: | --- | --- | --- | --- |
| 1 | MSFT | 可观察候选 | 共振 82; 预期差 77.19; 赔率 65.0; 风险 0; 闸门 不具备高置信优势; 信号 confirmed | 历史相似样本不足 / 逼空/期权相关数据为 proxy / 精准闸门未通过 |
| 2 | MRK | 可观察候选 | 共振 78.38; 预期差 58; 赔率 63.95; 风险 0; 闸门 不具备高置信优势; 信号 partial | 历史相似样本不足 / 逼空/期权相关数据为 proxy / 精准闸门未通过 |
| 3 | LLY | 可观察候选 | 共振 77.67; 预期差 58; 赔率 63.23; 风险 0; 闸门 不具备高置信优势; 信号 partial | 历史相似样本不足 / 逼空/期权相关数据为 proxy / 精准闸门未通过 |
